...
class LeitorFonteDadosXMLTest {
  ...
  @Test
  void deveRecuperarPedidoDoXML() {
    LeitorFonteDadosXML leitor = new LeitorFonteDadosXML();

    String nomeArquivo = LeitorFonteDadosXMLTest.class.getResource("/itens-pedido-teste.xml").getFile();
